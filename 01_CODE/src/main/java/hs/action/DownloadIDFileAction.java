...
@Namespace("/")
@Action(value = "downloadIDFileAction")
@Results({ @Result(name = "downloadID", type = "stream", params = { "contentType", "application/octet-stream", "inputName", "inputStream", "contentDisposition", "attachment;filename=\"${downloadFileName}\"", "bufferSize", "4096" })
         ,@Result(name = "nofile", location = "/error/noIDFile.jsp")})
public class DownloadIDFileAction extends ActionSupport {
