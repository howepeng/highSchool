 ...
 *
 */
public class GaokaoScore implements Serializable {
    ...
    private File gaokaoScoreFile;// 上传的文件
    private String gaokaoScoreFileContentType; // 封装上传文件类型的属性
    private String gaokaoScoreFileFileName; // 封装上传文件名的属性
    ...
    public File getGaokaoScoreFile() {
        return gaokaoScoreFile;
    }

    public void setGaokaoScoreFile(File gaokaoScoreFile) {
        this.gaokaoScoreFile = gaokaoScoreFile;
    }

    public String getGaokaoScoreFileContentType() {
        return gaokaoScoreFileContentType;
    }

    public void setGaokaoScoreFileContentType(String gaokaoScoreFileContentType) {
        this.gaokaoScoreFileContentType = gaokaoScoreFileContentType;
    }

    public String getGaokaoScoreFileFileName() {
        return gaokaoScoreFileFileName;
    }

    public void setGaokaoScoreFileFileName(String gaokaoScoreFileFileName) {
        this.gaokaoScoreFileFileName = gaokaoScoreFileFileName;
    }
}
